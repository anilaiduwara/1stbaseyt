...
const search = await fetchJson(`https://www.dark-yasiya-api.site/search/yt?text=${q}`)
const data = search.result.data[0];
const url = data.url
    
const ytdl = await fetchJson(`https://www.dark-yasiya-api.site/download/ytmp3?url=${data.url}`)
